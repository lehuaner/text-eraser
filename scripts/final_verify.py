...
for name in ['needExtractAndPatch.png', 'needExtractAndPatch2.png']:
    ...
    Image.fromarray(r_def).save(r'D:\Code\Project\Python\TextPatch\data\result\\' + name.replace('.png','') + '_F_default.png')
    Image.fromarray(r_d60).save(r'D:\Code\Project\Python\TextPatch\data\result\\' + name.replace('.png','') + '_F_dir60.png')
    Image.fromarray(r_d150).save(r'D:\Code\Project\Python\TextPatch\data\result\\' + name.replace('.png','') + '_F_dir150.png')
