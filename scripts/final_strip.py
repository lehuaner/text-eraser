...
orig = np.asarray(Image.open(r'D:\Code\Project\Python\TextEraser\data\needExtractAndPatch2.png').convert('RGB'))
def_ = np.asarray(Image.open(r'D:\Code\Project\Python\TextEraser\data\result\needExtractAndPatch2_F_default.png').convert('RGB'))
d60  = np.asarray(Image.open(r'D:\Code\Project\Python\TextEraser\data\result\needExtractAndPatch2_F_dir60.png').convert('RGB'))
d150 = np.asarray(Image.open(r'D:\Code\Project\Python\TextEraser\data\result\needExtractAndPatch2_F_dir150.png').convert('RGB'))
...
for lab, im in panels:
    ...
    x += im.size[0] + 8
canvas.save(r'D:\Code\Project\Python\TextEraser\data\result\FINAL_img2_strip.png')
