...
for name in ['needExtractAndPatch.png', 'needExtractAndPatch2.png']:
    ...
    Image.fromarray(r_def).save(r'D:\Code\Project\Python\TextEraser\data\result\\' + name.replace('.png','') + '_v2_default.png')
    Image.fromarray(r_d60).save(r'D:\Code\Project\Python\TextEraser\data\result\\' + name.replace('.png','') + '_v2_dir60.png')
print("regenerated")
