...
orig1 = load(r'D:\Code\Project\Python\TextEraser\data\needExtractAndPatch.png')
orig2 = load(r'D:\Code\Project\Python\TextEraser\data\needExtractAndPatch2.png')
# 默认结果（重新跑以保证一致）
...
dir60_1 = load(r'D:\Code\Project\Python\TextEraser\data\result\needExtractAndPatch_dir60.png')
dir60_2 = load(r'D:\Code\Project\Python\TextEraser\data\result\needExtractAndPatch2_dir60.png')
dirN30_2 = load(r'D:\Code\Project\Python\TextEraser\data\result\needExtractAndPatch2_dir-30.png')

strip([('原图',orig1),('默认(无方向)',def1),('方向60°',dir60_1)],
      'img1 武器  — 默认 vs 方向60°', r'D:\Code\Project\Python\TextEraser\data\result\cmp_img1.png')
strip([('原图',orig2),('默认(无方向)',def2),('方向60°',dir60_2),('方向-30°',dirN30_2)],
      'img2 座驾 — 默认 vs 方向60° vs 方向-30°', r'D:\Code\Project\Python\TextEraser\data\result\cmp_img2.png')
